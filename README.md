# Final Project for EDA Postgraduate Course
...
[![N|Solid](https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/B-tree.svg/600px-B-tree.svg.png)](https://www.unsa.edu.pe)
...
EDA-BTree-Final-Project uses a number of open source projects to work properly:
...
And of course EDA-BTree-Final-Project itself is open source with a [public repository][dill]
 on GitHub.
...
```sh
$ cd /home/user/eda-final-project
$ python eda-project.py
```
...
EDA-BTree-Final-Project uses python for fast developing.

### Docker
EDA-BTree-Final-Project is very easy to install and deploy in a Docker container.
...
docker build -t joemccann/dillinger:${package.json.version} .
```
This will create the EDA-BTree-Final-Project image and pull in the necessary dependencies. Be sure to swap out `${package.json.version}` with the actual version of EDA-BTree-Final-Project.
